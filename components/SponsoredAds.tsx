    ...
    return (
        <div className="p-4 bg-white rounded-lg shadow-md text-sm">
            ...
            <div className="flex items-center justify-between text-gray-500 font-medium">
                <h4 className="">Sponsored Ads</h4>
                <Image src="/more.png" alt="more" width={16} height={16} />
            </div>
            {/* bottom */}
            <div className={`flex flex-col mt-4 ${size === "sm" ? "gap-2" : "gap-4"}`}>
                <div className={`relative w-full ${size === "sm" ? "h-24" : size === "md" ? "h-36" : "h-48"}`}>
                    <Image src="https://images.pexels.com/photos/10761134/pexels-photo-10761134.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="" fill sizes="100%" className=" rounded-lg object-cover" />
                </div>
                <div className="flex items-center gap-4">
                    ...
                    <h6 className="text-blue-500 font-medium">Emilie Douglas</h6>
                </div>
